...
set(stdout_log "/Users/shall/WeBank/solidity/solidity/deps/src/boost-stamp/boost-configure-out.log")
set(stderr_log "/Users/shall/WeBank/solidity/solidity/deps/src/boost-stamp/boost-configure-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/shall/WeBank/solidity/solidity/deps/src/boost-stamp/boost-configure-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "boost configure command succeeded.  See also /Users/shall/WeBank/solidity/solidity/deps/src/boost-stamp/boost-configure-*.log")
    message(STATUS "${msg}")
  endif()
endif()
